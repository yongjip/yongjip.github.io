...
summary: forecast는 입력 중 하나였을 뿐입니다. 이 시스템은 재고 상태, 시점, 신선도, 창고 운영 제약을 함께 반영해 실제로 사용할 수 있는 발주 추천을 만들었습니다.
kind: work
featured: false
order: 3
related:
...
<section class="detail-section">
  ...
  <div class="detail-columns">
    <article class="detail-item">
      <h3>운영 출력값</h3>
      <p>
        엔진은 추천 발주량과 함께 재고 전망을 계산했습니다. 그래서 운영팀은 발주 추천을 단순한 숫자가 아니라 이후 재고 흐름과 함께 검토할 수 있었습니다.
      </p>
    </article>
    <article class="detail-item">
      <h3>결정 설명</h3>
