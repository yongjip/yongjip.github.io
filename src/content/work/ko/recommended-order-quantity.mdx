...
facts:
  - label: 범위
    value: forecast, inventory, lead time, codelife, open PO, MOQ, pallet handling, 주문 가능 일정.
  - label: 출력
...
<section class="detail-section detail-section-flow">
  ...
  <h2>이 시스템은 입력과 제약을 단계적으로 반영해 실제 발주량을 만들었습니다.</h2>
  <ResponsiveDiagram
