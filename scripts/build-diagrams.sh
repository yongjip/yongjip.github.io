...
render_diagram "text-to-sql-en-mobile.mmd" "text-to-sql-en-mobile.png"
render_diagram "text-to-sql-ko.mmd" "text-to-sql-ko.png"
render_diagram "text-to-sql-ko-mobile.mmd" "text-to-sql-ko-mobile.png"
render_diagram "roq-en.mmd" "roq-en.png"
render_diagram "roq-en-mobile.mmd" "roq-en-mobile.png"
render_diagram "roq-ko.mmd" "roq-ko.png"
render_diagram "roq-ko-mobile.mmd" "roq-ko-mobile.png"
